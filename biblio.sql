...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 08 août 2022 à 16:37
...
(50, '  2-07-036822', 'Horreur', 2400, 'Horreur', 2003, 'Francais', 18, 8);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view1`  AS SELECT `auteur`.`num` AS `num`, `auteur`.`nom` AS `nom`, `auteur`.`prenom` AS `prenom`, `auteur`.`numNationalite` AS `numNationalite` FROM `auteur` ;
...
--
ALTER TABLE `genre`
  MODIFY `num` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `livre`
--
ALTER TABLE `livre`
  MODIFY `num` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT pour la table `nationalite`
--
ALTER TABLE `nationalite`
  MODIFY `num` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `nationalite`
  ADD CONSTRAINT `nationalite_ibfk_1` FOREIGN KEY (`numContinent`) REFERENCES `continent` (`num`);
